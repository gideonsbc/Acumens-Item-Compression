report 14305133 "AQDLC Move ILE To Old Number"
{
    ...
    procedure SetRunParameters(vStartingILENumber: Integer; vCompressionRegNo: Integer; vStartingVLENumber: Integer; vMaxPostingDate: Date; vShowDialog: Boolean)
    begin
